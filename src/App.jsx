...
function App() {
    ...
    const verifyToken = async (token) => {
        try {
            ...
            if (response.data.isValid) {
                return {userName: response.data.userName}; // Only return userName if token is valid
            } else {
        ...
        if (token) {
            ...
            verifyToken(token).then(userData => {
                if (userData) {
                    ...
                    setUserName(userData.userName);  // Set the userName from the API
                } else {
    ...
    const handleLogin = (userData) => {
        ...
        //setIsAdmin(userData.role === 'admin'); // Assuming your API returns a "role" field - REMOVE THIS LINE
        setIsAdmin(userData.userName === 'admin'); // Use the userName for admin check
        // console.log("admin" , isAdmin)
        // console.log("App.js handleLogin userData:", userData);
    };
